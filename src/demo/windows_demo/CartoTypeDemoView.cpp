...
void CCartoTypeDemoView::CreateTurnInstructions()
    {
    auto legend = std::make_unique<CartoType::Legend>(*m_framework,CartoType::Legend::KTurnStyle);
...
void CCartoTypeDemoView::OnInitialUpdate()
    ...
    auto sb = std::make_unique<CartoType::Legend>(*m_framework,CartoType::Legend::KScaleStyle);
