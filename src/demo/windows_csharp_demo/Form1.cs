...
namespace CartoTypeDemo
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            m_speech_synthesizer.SetOutputToDefaultAudioDevice();
        ...
        private SpeechSynthesizer m_speech_synthesizer = new SpeechSynthesizer();
        ...
        private void Navigate(int aValidity,double aTime,double aLong,double aLat,double aSpeed,double aBearing, double aHeight)
        {
            ...
            switch (m_framework.NavigationState)
            {
                ...
                default:
                    message = m_first_turn.Instructions;
                    break;
            }

            m_status_bar.Text = message;

            // Issue a voice instruction if there is one.
            var voice_instruction = m_framework.VoiceInstruction;
            if (voice_instruction.Length > 0)
                m_speech_synthesizer.SpeakAsync(voice_instruction);
        ...
        private void Form1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                // Simulate a navigation position on shift-click.
            ...
            else if (e.Button == MouseButtons.Right)
            {
                ...
                {
                    // Create a new route and start navigating along it.
        ...
        {
            CartoType.Legend legend = new CartoType.Legend(m_framework, CartoType.LegendStyleFlag.StandardStyle);
            var p = new CartoType.NoticePosition(CartoType.NoticeAnchor.TopRight, 2.5, "in");
            m_framework.SetLegend(p, legend);
        }
